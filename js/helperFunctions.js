...
var eventFunctions = {
  ...
  "addEnzyme": function() {
    ...
    animate("#micropipette2", 0, "keyframe", "anim_pipetToTube1")
  ...
  "closeLid": function() {
    ...
    animate("#timerButton,#timer", 1000, "show");
  ...
  "setTimerPost": function() {
    ...
    animate("#timer,#timerButton", 1, "hide");
  ...
  "prepPipet1": function(evt) {
    ...
    animate("#micropipette2", 0, "keyframe", "anim_PrepPipet")
